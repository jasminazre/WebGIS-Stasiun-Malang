...
map.getView().fit([12525249.886094, -901337.035408, 12553827.048195, -882939.760662], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KETERJANGKAUAN STASIUN KERETA API KOTA MALANG</h2>';
        return titleElement;
    })(),
